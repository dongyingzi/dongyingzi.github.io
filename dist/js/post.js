$(document).ready(function(){
    ...
    //***********************
    //**评论的代码也删掉哦***
    window.disqus_shortname = 'dongyingzi'; // required: replace example with your forum shortname
    ...
    $('.entry a').each(function(index,element){
        ...
        if(href){
            if(href.indexOf('#') == 0){
            }else if ( href.indexOf('/') == 0 || href.toLowerCase().indexOf('dongyingzi.github.io')>-1 ){
    ...
    (function(){
        function initHeading(){
            ...
            $.each($('.yz-art-single h2, .yz-art-single h3'),function(index,item){
        ...
        function genTmpl(){
            var h1txt = $('h1').text();
            var tmpl = '<ul class="yz-nav"><li><a href="#">' + h1txt + '</a></li>';
        ...
        if($('.yz-art-single h2').length > 2 && !isMobile.any()){
            ...
            $(window).load(function(){
                ...
                $(window).resize(function(){
                    ...
                    $('#menuIndex').css('max-height',$(window).height()-100);
                });
            })
    ...
    $.getScript('/dist/js/prettify/prettify.js',function(){
        prettyPrint();
    });
